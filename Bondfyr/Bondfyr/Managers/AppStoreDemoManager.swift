...
class AppStoreDemoManager: ObservableObject {
    ...
    private func updateDemoUserProfile(userId: String) async {
        let userData: [String: Any] = [
            ...
            "location": GeoPoint(latitude: 37.7749, longitude: -122.4194), // SF coordinates for demo parties
    ...
    private func generateDemoParties() -> [[String: Any]] {
        ...
        return [
            ...
            [
                ...
                "description": "App Store Demo Party! Test hosting features - manage guests, payments, and all host controls.",
                "address": "123 Demo St, San Francisco, CA",
                "googleMapsLink": "https://maps.google.com/?q=123+Demo+St+San+Francisco",
                "vibeTag": "🎉 Energetic",
                ...
                "title": "Demo Host Experience 🎉",
                "ticketPrice": 0.0, // Free for demo
                "coverPhotoURL": "",
                "maxGuestCount": 20,
                "visibility": "public",
                "approvalType": "manual",
            ...
            [
                ...
                "city": "San Francisco",
                "locationName": "Trendy Bar Downtown",
                "description": "Join this party to test the guest experience! Request to join, see party details, and interact as a guest.",
                "address": "456 Guest Ave, San Francisco, CA",
                "googleMapsLink": "https://maps.google.com/?q=456+Guest+Ave+San+Francisco",
                "vibeTag": "🍸 Chill",
                "activeUsers": ["user1", "user2"],
                "pendingRequests": [],
                "createdAt": Calendar.current.date(byAdding: .hour, value: -2, to: baseDate) ?? baseDate,
                "title": "Demo Guest Experience 🍸",
                "ticketPrice": 0.0, // Free for demo
                "coverPhotoURL": "",
                "maxGuestCount": 15,
                "visibility": "public",
            ...
            [
                ...
                "address": "789 Weekend Blvd, San Francisco, CA",
                "googleMapsLink": "https://maps.google.com/?q=789+Weekend+Blvd+San+Francisco",
                "vibeTag": "🌟 Exclusive",
                "activeUsers": ["user3", "user4", "user5"],
                "pendingRequests": [],
                "createdAt": Calendar.current.date(byAdding: .minute, value: -45, to: baseDate) ?? baseDate,
                "title": "Weekend Demo Party 🌟",
                "ticketPrice": 0.0,
                "coverPhotoURL": "",
                "maxGuestCount": 30,
                "visibility": "public",
